...
CREATE TABLE user_profiles (
	...
	invest_profile_id TINYINT UNSIGNED NOT NULL COMMENT 'Инвистиционный профиль',
...
CREATE TABLE bounds (
	id SERIAL PRIMARY KEY,
	symbol VARCHAR(15) NOT NULL COMMENT 'Обозначение эмитента',
	...
	market_id TINYINT UNSIGNED NOT NULL COMMENT 'ID типа рынка',
	FOREIGN KEY (market_id) REFERENCES markets (id)
